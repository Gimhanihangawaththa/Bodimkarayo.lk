        ...
        <div className="flex items-center gap-3 shrink-0">
          {isLoggedIn ? (
            <div className="flex items-center gap-4">
              ...
              <Link to="/profile" className="h-10 w-10 rounded-full bg-gray-300 flex items-center justify-center text-gray-600 font-semibold cursor-pointer hover:bg-gray-400 transition overflow-hidden shadow-sm">
              ...
              <Link to="/settings" className="text-gray-600 hover:text-blue-600 transition p-2 rounded-full hover:bg-gray-100" title="Settings">
